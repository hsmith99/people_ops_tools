/**
 * Update Employee List in Manager Confirmation Form
 * 
 * This script should be added to the Manager Confirmation Form's script editor.
 ...
 * 5. Replace 'Confirm or Reselect Peer Reviewers' with your exact question title (if different)
