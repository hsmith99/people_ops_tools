/**
 * COMPLETE Review Form Script
 * 
 * Copy this ENTIRE file to your Performance Review Form's script editor
 * (Form → Three dots → Script editor)
 * 
 * SETUP:
 * 1. Replace YOUR_SPREADSHEET_ID_HERE with your actual spreadsheet ID
 * 2. Set up trigger: Triggers → Add Trigger → From form → On form submit → onFormSubmit
 */
